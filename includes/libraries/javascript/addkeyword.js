...
function zsc_show(id){
	...
	if(zsc_class!='add'){
		...
		click_id = id;
		var zsc_id = id;
		var url = "index.php?app=wechat&act=addkeyword_ajax&kid="+zsc_id;
		$.post(url,null,function(data){
			...
			//$.each(data,function(i,v){
				...
				zsc_html = "<div class=\"edit-info\">"+
						   ...
						   "<img id=\"zsc_imgs0\" src=\"themes/mall/default/styles/default/keyword/images/bigimg.jpg\" width=\"295\" height=\"126\"/>"+
						   "<span id=\"zsc_titles0\">标题</span>"+
						   "<b class=\"modify\"><img id=\"zsc_simg0\""+
						   " src=\"themes/mall/default/styles/default/keyword/images/op-modify.png\" onclick=\"zsc_editimg(0)\"/></b>"+
						   ...
						   "<img src=\"themes/mall/default/styles/default/keyword/images/keywords_28.jpg\" class=\"add1\" "+
						   "style=\"cursor:pointer;\" onclick=\"zsc_addimg(1)\" />"+
						   "</div>"+
						   "</div>"+
						   "<div class=\"tuwen_right\">"+
						   "<img src=\"themes/mall/default/styles/default/keyword/images/keywords_15.jpg\">"+
						   "<p>"+
						   "<br />"+
						   ...
						   "</p>"+
						   "<img src=\"themes/mall/default/styles/default/keyword/images/keywords_19.jpg\">"+ 
						   "</div>"+
						   "<div style=\" padding-top:45px; clear:both;\">"+
...
function zsc_addimg(num){
	if($('.simgcon').length<9){
		...
		var zsc_html = "<a href=\"javascript:;\" class=\"simgcon\" id=\"zsc_imgs"+num+"\">"+
					   "<span>标题</span>"+
					   "<img src=\"themes/mall/default/styles/default/keyword/images/smallimg.jpg\" id=\"zsc_simg"+num+"\" />"+
					   "<b class=\"smodify\"><img src=\"themes/mall/default/styles/default/keyword/images/op-modify.png\" onclick=\"zsc_editimg("+num+")\" />"+
					   "<img src=\"themes/mall/default/styles/default/keyword/images/op-del.png\" onclick=\"zsc_delimg("+num+")\" /></b>"+
...
function btnsave(num,count){
	...
	if(ktype==1){
		...
		if(count==0){
			var url = "index.php?app=wechat&act=keyword_index&op=add";
			...
			var url = "index.php?app=wechat&act=keyword_index&op=update";
			var kid = $('#zsc_iid').val();
...
function zscdel(num){
	...
	var url = "index.php?app=wechat&act=keyword_index&op=del";
