    ...
    function index()
    {
        ...
        else
        {
            ...
            $data = array_merge($data, array(
                ...
                'store_new_images'=>$_POST['store_new_images'],
                'store_recommend_images'=>$_POST['store_recommend_images'],
                'store_hot_images'=>$_POST['store_hot_images'],
            ));
