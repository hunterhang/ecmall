...
<style>
/* 底部 */
.footer{text-align:center; font-size:12px;  overflow:hidden; clear:both; margin-top:10px; clear:both;}
.footer .auto{padding:15px 0; margin:0 auto; width:980px; color:#666;border-top:#ddd solid 1px;}
...
<body>
<div id="header">
    <h1 title="<?php echo $this->_var['site_title']; ?>"><a href="index.php"><img style="height:60px;" src="<?php echo $this->_var['site_logo']; ?>" alt="<?php echo $this->_var['site_title']; ?>" /></a></h1>
    <div id="subnav">
        <p>
