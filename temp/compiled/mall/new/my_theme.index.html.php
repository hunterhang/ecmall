...
function preview_theme_no(screenshot){
    var screenshot = '<?php echo $this->_var['site_url']; ?>/' + screenshot;
            ...
            <div class="public" style="padding:30px 0">
                ...
                <div class="information_index">
                    <div class="templet">
                        ...
                        <div class="txt">
                            <p><a href="<?php echo url('app=store&act=index_view&id=' . $this->_var['id']. ''); ?>" target="_blank" class="btn">商城预览</a></p>
                          <!--  <p>店铺名称:<span><?php echo htmlspecialchars($this->_var['store']['store_name']); ?></span><a href="<?php echo url('app=store&id=' . $this->_var['id']. ''); ?>" target="_blank" class="btn">店铺首页</a></p>-->
...
?>
                            <li>
                                <p><a href="javascript:;" onclick="preview_theme('<?php echo htmlspecialchars($this->_var['theme']['template_name']); ?>', '<?php echo htmlspecialchars($this->_var['theme']['style_name']); ?>');"><img id="themeimg_<?php echo htmlspecialchars($this->_var['theme']['template_name']); ?>_<?php echo htmlspecialchars($this->_var['theme']['style_name']); ?>" src="<?php echo $this->_var['site_url']; ?>/themes/store/<?php echo htmlspecialchars($this->_var['theme']['template_name']); ?>/styles/<?php echo htmlspecialchars($this->_var['theme']['style_name']); ?>/preview.jpg"  width="200" height="140" ></a></p>
                                 <h2><?php echo htmlspecialchars($this->_var['theme']['temp_name']); ?></h2>
                      ...
                      <?php if ($this->_var['skins_no']): ?>
                    <h5 class="motif_title">不可用主题</h5>
                    <div class="motif">
                         <ul>
                        <?php $_from = $this->_var['skins_no']; if (!is_array($_from) && !is_object($_from)) { settype($_from, 'array'); }; $this->push_vars('', 'theme');if (count($_from)):
    foreach ($_from AS $this->_var['theme']):
?>
                            <li>
                                <p><a href="javascript:;" onclick="preview_theme_no('<?php echo htmlspecialchars($this->_var['theme']['screenshot']); ?>');"><img id="themeimg_<?php echo htmlspecialchars($this->_var['theme']['template_name']); ?>_<?php echo htmlspecialchars($this->_var['theme']['style_name']); ?>" src="<?php echo $this->_var['site_url']; ?>/<?php echo $this->_var['theme']['preview']; ?>"  width="200" height="140" ></a></p>
                                 <h2><?php echo htmlspecialchars($this->_var['theme']['temp_name']); ?></h2>
                              <!-- <h2>模板名称: <?php echo htmlspecialchars($this->_var['theme']['template_name']); ?><br />风格名称: <?php echo htmlspecialchars($this->_var['theme']['style_name']); ?></h2>-->
                                <span>
                                   <a onclick="alert('VIP等级不够,不可使用。');" href="javascript:;" class="employ">使用</a>
                                    <a href="javascript:preview_theme_no('<?php echo htmlspecialchars($this->_var['theme']['screenshot']); ?>');" class="preview">预览</a>
                                </span>
                            </li>
                        <?php endforeach; endif; unset($_from); ?><?php $this->pop_vars();; ?>
                        </ul>
