...
<div>
    ...
    <div id="banner" class="auto1"> 
        <div id="banner_list"> 
            <a href="<?php echo url('app=default&act=zifei'); ?>" target="_blank"><img src="/mall/banner_1.jpg"/></a> 
            <a href="<?php echo url('app=default&act=zifei'); ?>" target="_blank"><img src="/mall/banner_2.jpg"/></a>
            <a href="<?php echo url('app=default&act=zifei'); ?>" target="_blank"><img src="/mall/banner_3.jpg"/></a> 
        </div> 
        <ul> 
    ...
    <div class="process auto1">
    	<span>开通流程</span>
        <ul>
        	<li><b>1</b>注册会员账号<img src="/themes/mall/default/styles/default/images/new/process_arrow.png" /></li>
            <li><b>2</b>开通Vip套餐<img src="/themes/mall/default/styles/default/images/new/process_arrow.png" /></li>
            <li><b>3</b>设置微商城信息<img src="/themes/mall/default/styles/default/images/new/process_arrow.png" /></li>
            <li><b>4</b>绑定微信接口</li>
         </ul>
    </div>
    <style>
	...
	.process li b{background:url(/themes/mall/default/styles/default/images/new/process.png) no-repeat 0 20px; color:#fff; display:inline-block; width:30px; height:70px; line-height:70px; text-align:center; margin-right:10px;}
    </style>
    ...
    <div class="auto1 partner">
    	<ul>
        	...
        	<li><img src="<?php echo $this->res_base . "/" . 'images/new/partner1.gif'; ?>" /></li>
        	...
        	<li><img src="<?php echo $this->res_base . "/" . 'images/new/partner6.gif'; ?>" /></li>
        </ul>
    </div>
