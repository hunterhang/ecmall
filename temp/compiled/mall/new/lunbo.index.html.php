    ...
    if(file_data.instance == 'goods_image'){
        ...
        var html="<li id='li"+ file_data.file_id +"'>";
         ...
         html+=" <div style='width:360px;'  class='arrange'>";
          html+="<input  style='width:268px;'  type='text' name='lunbo_link["+ file_data.file_id +"]' class='text width_normal' /> <a target='_blank' href='<?php echo url('app=my_category&act=link'); ?>'>点击获取链接</a></div>";
            ...
            <div class="public" style="height:700px;">
               <!-- <form method="post" id="goods_form">-->
                    <div class="information_index">
                        ...
                        <h4>首页轮播图&nbsp;&nbsp;&nbsp;(<font style="color:red;">图片大小推荐640*400，2--4张效果最佳。</font>)</h4>
                        <div class="add_wrap">
...
?>
                                        ...
                                        <div class="pic">
                                            ...
                                            <div ectype="handler" class="bg">
                                                    <p class="operation">
                                                        ...
                                                        <span class="delete" ectype="drop_lunbo_image" ecm_title="删除"></span>
                                                    </p>
                                            </div>
                                        </div>
                                        </li>
                           ...
                           <form method="POST" action="index.php?app=lunbo">
                                <ul id='lunbo_link'>  
                                 <?php if ($this->_var['goods_images']): ?> 
                               <?php $count=1; ?>
                                <?php $_from = $this->_var['goods_images']; if (!is_array($_from) && !is_object($_from)) { settype($_from, 'array'); }; $this->push_vars('key', 'goods_iamge');if (count($_from)):
    foreach ($_from AS $this->_var['key'] => $this->_var['goods_iamge']):
?>
                                    <li  id="li<?php echo $this->_var['goods_iamge']['file_id']; ?>">
                                        <h2 style="width:70px;">广告图链接<?php echo $count; $count+=1; ?>: </h2>
                                        <div style="width:360px;"  class="arrange">
                                        <input  style="width:268px;"  type="text" name="lunbo_link[<?php echo $this->_var['goods_iamge']['file_id']; ?>]" value="<?php echo $this->_var['goods_iamge']['image_link']; ?>" class="text width_normal" />
                                      <a target="_blank" href="<?php echo url('app=my_category&act=link'); ?>">点击获取链接</a>
                                          </div>
                                    </li>
                                <?php endforeach; endif; unset($_from); ?><?php $this->pop_vars();; ?>
