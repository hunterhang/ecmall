...
?>
                                ...
                                <p class="new_add">
                                    ...
                                    <span>可以从属于多个本店分类<a style="margin-left:10px; color:#85c401;" href="<?php echo url('app=my_category'); ?>">（如本店还未设置分类，点击此处前往设置）</a></span>
                                </p>
                            </div>
                        </div>
                            ...
                            <div class="products">
                                ...
                                <!--    <li>
                                    ...
                                    <li>
                                     ...
                                     <li>
                                        <h2 >原价: </h2>
                                        <div class="arrange" ><input name="cost_price" value="<?php echo htmlspecialchars($this->_var['goods']['cost_price']); ?>" type="text" class="text width_short" />
                                         <span class="gray">可不填，如果不填写可以填写0或者直接不填写</span></div>
                                    </li>
                                    ...
                                    <li>
                                        ...
                                        <div class="arrange">
                                            <span class="distance">
                                                <label><input name="recommended" value="1" <?php if ($this->_var['goods']['recommended']): ?>checked="checked" <?php endif; ?>type="radio" name="c2" /> 是</label>
                                                <label><input name="recommended" value="0" <?php if (! $this->_var['goods']['recommended']): ?>checked="checked" <?php endif; ?>type="radio" name="c2" /> 否</label>
                                            </span>
                        ...
                        <div class="add_bewrite">
                            ...
                            <div class="add_wrap">
                                <div class="editor">
                                    ...
                                    <div style=" position: relative; top: 10px; z-index: 5;"><a class="btn3" id="open_editor_uploader"  style="display:inline-block;">上传图片</a>
                                        <b>上传图片成功后，把鼠标放在图片上，在点击第一个图标,即可插入图片。</b>
