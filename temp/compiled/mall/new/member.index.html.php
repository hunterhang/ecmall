                    ...
                    <div class="info">
                        ...
                        <table class="width6">
                            <tr>
                                ...
                                卖家信用:
                             <!--    <a href="<?php echo url('app=store&act=credit&id=' . $this->_var['store']['store_id']. ''); ?>" target="_blank"><?php echo $this->_var['store']['credit_value']; ?></a>--><?php echo $this->_var['store']['credit_value']; ?><?php if ($this->_var['store']['credit_value'] >= 0): ?> <img src="<?php echo $this->_var['store']['credit_image']; ?>" />
                                  <?php endif; ?>
                                <?php endif; ?>
                                </td>
                            </tr>
            ...
            <div class="public_index">
                <div class="information_index">
                    ...
                    <div class="remind">
                       ...
                       <!--  <a href="<?php echo url('app=my_store'); ?>" title="查看我的店铺"  class="btn1 pos2"><span class="pic2">查看我的店铺</span></a>
                       ...
                       <!--<a href="<?php echo url('app=store&act=index_view&id=' . $this->_var['store']['store_id']. ''); ?>" title="查看我的店铺" target="_blank" class="btn1 pos2"><span class="pic2">查看我的店铺</span></a>-->
                       <!-- <a href="<?php echo url('app=seller_order'); ?>" class="btn pos3" title="管理我的订单"><span class="pic1">管理我的订单</span></a>-->
                         <!--<a target="_blank" class="btn1 " target="_blank"  href="<?php echo $this->res_base . "/" . 'images/shili.jpg'; ?>" ><span class="pic2">商城全景预览</span></a>-->
                       <!--<a href="<?php echo $this->res_base . "/" . 'images/liucheng.jpg'; ?>" target="_blank" class="btn pos3"><span class="pic1">使用流程示意图</span></a>
                        	...
                        	<div class="tb_con_c">
                            	<ol class="steps_t">
                                	<li>
                                        ...
                                        <div class="stepsa"><a href="<?php echo $this->res_base . "/" . 'images/liucheng.jpg'; ?>" target="_blank" class="btn pos3"><span class="pic1">使用流程示意图</span></a></div>
                                        <div class="stepstxt">商城主要使用信息配置说明 &nbsp;&nbsp;&nbsp;&nbsp;  <a href="<?php echo $this->res_base . "/" . 'images/liucheng.jpg'; ?>" target="_blank">查看详情</a></div>
                                    </li>
                                    <li>
                                    	<div class="stepsimg">2</div>
                                        <div class="stepsa"><a href="<?php echo $this->res_base . "/" . 'images/shili.jpg'; ?>" target="_blank" class="btn pos3"><span class="pic2">商城全景预览</span></a></div>
                                        <div class="stepstxt">手机最终效果与管理中心对应设置项说明 &nbsp;&nbsp;&nbsp;&nbsp;  <a href="<?php echo $this->res_base . "/" . 'images/shili.jpg'; ?>" target="_blank">查看详情</a></div>
                                    </li>
                                    <li>
                                    	<div class="stepsimg">3</div>
                                        <div class="stepsa"><a href="<?php echo url('app=store&act=index_view&id=' . $this->_var['store']['store_id']. ''); ?>" class="btn pos3"><span class="pic2">查看我的店铺</span></a></div>
                                        <div class="stepstxt">手机最终效果预览 &nbsp;&nbsp;&nbsp;&nbsp;  <a href="<?php echo url('app=store&act=index_view&id=' . $this->_var['store']['store_id']. ''); ?>" >查看详情</a></div>
                                    </li>
                                    <li>
