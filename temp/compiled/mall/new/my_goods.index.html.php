                ...
                <table id="my_goods" server="<?php echo $this->_var['site_url']; ?>/index.php?app=my_goods&amp;act=ajax_col" >
                    ...
                    <tr class="gray"  ectype="table_header">
                      ...
                      <!--  <?php if ($this->_var['store']['enable_radar']): ?>
                        <th width="50">全网比价</th>
                        <?php endif; ?>-->
                        <th width="240" coltype="editable" column="goods_name" checker="check_required" inputwidth="90%" title="排序"  class="cursor_pointer"><span ectype="order_by">商品名称</span></th>
                        ...
                        <th width="55" coltype="editable" column="views" checker="check_required" inputwidth="55px" title="排序"  class="cursor_pointer"><span ectype="order_by">浏览次数</span></th>
...
?>
                    <tr class="line<?php if (($this->_foreach['_goods_f']['iteration'] == $this->_foreach['_goods_f']['total'])): ?> last_line<?php endif; ?>" ectype="table_item" idvalue="<?php echo $this->_var['goods']['goods_id']; ?>">
                        ...
                        <td width="50" class="align2"><a href="<?php echo url('app=goods&id=' . $this->_var['goods']['goods_id']. '&wx_store_id=' . $this->_var['store']['store_id']. ''); ?>" target="_blank"><img src="<?php echo $this->_var['site_url']; ?>/<?php echo $this->_var['goods']['default_image']; ?>" width="50" height="50"  /></a></td>
                     <!--   <?php if ($this->_var['store']['enable_radar']): ?>
                        ...
                        <td width="160" align="align2">
                          <p style="width:200px;" class="ware_text"><span class="color2" ectype="editobj"><?php echo htmlspecialchars($this->_var['goods']['goods_name']); ?></span></p>
                        </td>
                        ...
                        <td width="55" class="align2"><span class="color2" ><?php echo htmlspecialchars($this->_var['goods']['views']); ?></span></td>
                        ...
                        <td><div><a href="<?php echo url('app=my_goods&act=edit&id=' . $this->_var['goods']['goods_id']. '&ret_page=' . $this->_var['page_info']['curr_page']. ''); ?>" class="edit">编辑</a>
