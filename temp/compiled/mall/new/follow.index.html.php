...
<script type="text/javascript" src="<?php echo $this->lib_base . "/" . 'addfollows.js'; ?>" charset="utf-8"></script>
...
<script>
$(function(){
	$('input[name="is_follow"]').change(function(){
		$.post('index.php?app=wechat&act=checked_follow',{num:$(this).val()},function(data){
  ...
  <?php echo $this->fetch('member.menu.html'); ?>
    <div id="right">    
            <div class="wrap">
                ...
                <input name="is_follow" <?php if ($this->_var['info']['isno_follow'] == '1'): ?>checked<?php endif; ?> type="radio" value="1" style="margin-right:5px;" >开启自动回复 <input   <?php if ($this->_var['info']['isno_follow'] == '0'): ?>checked<?php endif; ?> name="is_follow" type="radio" value="0"  style="margin-right:5px;">关闭自动回复 
                </h3>-->
