                    ...
                    <div class="info_shop">
                        ...
                        <table>
                            ...
                            <tr>
                                ...
                                <td class="padding3"><span class="fontColor3">*</span> <span class="field_notice">请控制在20个字以内 （可更改）</span></td>
                            </tr>
                            <tr>
                                <th>所属分类: </th>
                                <td>
                                ...
                                <td class="padding3">可经营多种分类的产品</td>
                            </tr>
                            <tr>
                                <th>所在地区: </th>
                                <td>
                          ...
                          <!--  <tr>
                            ...
                            <tr>
                              ...
                              <tr>
                                ...
                                <?php if ($this->_var['store']['image_3']): ?><p style="display:inline;"><a href="<?php echo $this->_var['site_url']; ?>/<?php echo $this->_var['store']['image_3']; ?>" target="_blank">查看</a></p><?php endif; ?>
                                </td>
                                <td class="padding3"><span class="field_notice">支持格式jpg,jpeg,png,gif，请保证图片清晰且文件大小不超过400KB。</span></td>
                            </tr>-->
