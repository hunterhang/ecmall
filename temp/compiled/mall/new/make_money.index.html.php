        ...
        <div class="msgWrap">
            ...
            <div class="table">
             ...
             <div class="info individual">
                          <table>
                                <tr>
                                    <td><h3><font style="color:red;">我的积分：<?php echo $this->_var['info']['jifen']; ?></font><span style="color:#666; font-size:12px; margin-left:20px;">(积分可兑换现金，1积分=1元，满百可提现，提现与客服联系)</span><a target="_blank" href="http://wpa.qq.com/msgrd?v=3&uin=10086&site=qq&menu=yes"><img border="0" src="http://wpa.qq.com/pa?p=2:10086:41" alt="点击这里给我发消息" title="点击这里给我发消息" style="vertical-align:middle;  margin-left:5px;"/></a></h3>
                                    </td>
                                </tr> 
                                <tr>     
                                    <td>方式一：邀请好友注册并充值</td>
                                ...
                                <tr>
                                    <td>通过您的专属邀请链接推荐1名好友注册并充值，该好友充值金额返回5%</td>
                                </tr>
                                <tr>
