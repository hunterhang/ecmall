...
<ul class="tab">
    <li class="active"><?php if ($_GET['act'] == edit): ?>编辑配送方式<?php else: ?>新增配送方式<?php endif; ?></li>
</ul>
<div class="eject_con">
    <div class="info_table_wrap">
        ...
        <ul class="info_table">
            <li>
             ...
             <li><b style="color:#FF4D00;">快递名称请根据正确的命名，用户才能查看到物流信息(<a target="_blank" style="color:red;" href="<?php echo url('app=my_shipping&act=kuaidi'); ?>">点击查看快递命名</a>)</b></li>
         <!--   <li>
                <h4>简介:</h4>
        ...
        <h3>可货到付款地区<a target="_blank" href="<?php echo $this->res_base . "/" . 'images/huodaofukuan.jpg'; ?>" style="color:#39BAEA;float:right;">货到付款设置教程</a></h3>
        <ul class="info_table">
            <li>
                <h5>添加可货到付款的地区:</h5>
                <p>
