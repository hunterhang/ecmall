...
<script type="text/javascript" src="/js/new/jquery.carouFredSel-6.0.4-packed.js" charset="utf-8"></script>
            ...
            <table border="0" width="100%" class="price" cellspacing="0">
              <thead>
                <tr>
                    ...
                    <td style="background-color:#F2FCE6;border-bottom:3px solid #4DA94C;"><strong><?php echo htmlspecialchars($this->_var['sgrade']['grade_name']); ?></strong></td>
              ...
              <tbody>
                <tr>
                    ...
                    <td><?php if ($this->_var['sgrade']['goods_limit'] <> 'no_limit'): ?>上传商品<?php echo $this->_var['sgrade']['goods_limit']; ?>款<?php else: ?>不限制<?php endif; ?></td>
					
                </tr>
                <tr>
                    <td class="tip">商城模板数</td>
                    
                    <td><?php echo $this->_var['sgrade']['skin_limit']; ?>套</td>
					
                </tr>
                <tr class="prices">
                    <td class="tip">收费标准</td>
					
                    <td><?php echo $this->_var['sgrade']['charge']; ?>
					</td>
