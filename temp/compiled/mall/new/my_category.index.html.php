...
<div class="content">
    ...
    <div id="right"> <?php echo $this->fetch('member.submenu.html'); ?>
        <div class="wrap">
            <div class="eject_btn_two eject_pos3" title="新增分类"><b class="ico3" ectype="dialog" dialog_title="新增分类" dialog_id="my_category_add" dialog_width="650" uri="index.php?app=my_category&amp;act=add">新增分类</b></div>
                ...
                <table id="my_category" server="<?php echo $this->_var['site_url']; ?>/index.php?app=my_category&act=ajax_col">
                    ...
                    <tr class="gray" ectype="table_header">
                        ...
                        <th class="width3">操作</th>
                         ...
                         <!-- <tr class="line"  >
                    <td class="align2"></td>
                    <td class="width7"><img id="treet14" class="ttimage" src="<?php echo $this->res_base . "/" . 'images/treetable/tv-item-last.gif'; ?>">最新商品</td>
                    <td class="align2"></td>
                    <td>
                        <p class="padding2"><span <?php if ($this->_var['tubiao']['radio_new']): ?>class="right_ico" status="on"<?php else: ?>class="wrong_ico" status="off"<?php endif; ?>></span></p>
                        </td>
                    <td class="padding5">
                        <a href="javascript:void(0);" ectype="dialog" dialog_width="650" dialog_title="编辑" dialog_id="my_category_edit" uri="index.php?app=my_category&amp;act=tubiao_edit&amp;id=1" class="edit1">编辑</a> 
                        </td>
                  </tr>
                  <tr class="line"  >
                    <td class="align2"></td>
                     <td class="width7"><img id="treet14" class="ttimage" src="<?php echo $this->res_base . "/" . 'images/treetable/tv-item-last.gif'; ?>">推荐商品</td>
                    <td class="align2"></td>
                    <td>
                        <p class="padding2"><span <?php if ($this->_var['tubiao']['radio_recommend']): ?>class="right_ico" status="on"<?php else: ?>class="wrong_ico" status="off"<?php endif; ?>></span></p>
                        </td>
                    <td class="padding5">
   
                        <a href="javascript:void(0);" ectype="dialog" dialog_width="650" dialog_title="编辑" dialog_id="my_category_edit" uri="index.php?app=my_category&amp;act=tubiao_edit&amp;id=2" class="edit1">编辑</a> 

                        </td>
                </tr>
                  <tr class="line"  >
                    <td class="align2"></td>
                    <td class="width7"><img id="treet14" class="ttimage" src="<?php echo $this->res_base . "/" . 'images/treetable/tv-item-last.gif'; ?>">热门商品</td>
                    <td class="align2"></td>
                    <td>
                        <p class="padding2"><span <?php if ($this->_var['tubiao']['radio_hot']): ?>class="right_ico" status="on"<?php else: ?>class="wrong_ico" status="off"<?php endif; ?>></span></p>
                        </td>
                    <td class="padding5">
   
                        <a href="javascript:void(0);" ectype="dialog" dialog_width="650" dialog_title="编辑" dialog_id="my_category_edit" uri="index.php?app=my_category&amp;act=tubiao_edit&amp;id=3" class="edit1">编辑</a> 
                ...
                <tr class="line<?php if (($this->_foreach['v']['iteration'] == $this->_foreach['v']['total'])): ?> last_line<?php endif; ?>" ectype="table_item" idvalue="<?php echo $this->_var['gcategory']['cate_id']; ?>">
                    ...
                    <td class="padding5">
                        <?php if ($this->_var['gcategory']['layer'] < 2): ?>
                         <a href="javascript:void(0);" ectype="dialog" dialog_width="650" dialog_title="新增下级" dialog_id="my_category_add" uri="index.php?app=my_category&amp;act=add&amp;pid=<?php echo $this->_var['gcategory']['cate_id']; ?>" class="add1_ico">新增下级</a>
                        <?php endif; ?>
                        <a href="javascript:void(0);" ectype="dialog" dialog_width="650" dialog_title="编辑" dialog_id="my_category_edit" uri="index.php?app=my_category&amp;act=edit&amp;id=<?php echo $this->_var['gcategory']['cate_id']; ?>" class="edit1">编辑</a>  <a href="javascript:drop_confirm('删除该分类将会同时删除该分类的所有下级分类，您确定要删除吗', 'index.php?app=my_category&amp;act=drop&id=<?php echo $this->_var['gcategory']['cate_id']; ?>');" class="delete">删除</a>
