...
?>
      ...
      <tr>
       ...
       <tr>
        ...
        <td class="paddingT15 wordSpacing5"><input class="infoTableInput2" name="price" type="text" id="price" value="<?php echo $this->_var['sgrade']['price']; ?>" />
          <label class="field_notice">输入价格,实际收入价格</label> </td>
      </tr>
